  ...
  return (
    <ContentWrapper>
      ...
      <div className={ProjectStyle.projects}>
        <ul>
          <li>
            [Ezbaro] 산업 특화 Physical AI 파운데이션 모델 개발 및 차세대 융합형
            인재양성 (P1Y1)
          </li>
          <li>[Ezbaro] SW중심대학(P2Y1) 사업단</li>
          <li>[국고-7차년도) ICT-미래자동차 융합 교육연구단</li>
          <li>미래형자동차 핵심기술 전문인력 양성사업(3단계 1차년도)</li>
          <li>회전설비 인공지능형 진동 감시 시스템 개발(2단계 2차년도)</li>
          <li>
            [IRIS] 가동원전 일차계통 지능형 건전성 진단을 위한 인공지능 학습모델
            개발
          </li>
          <li>
